...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "import.heading": "Batch-Import",
        "import.intro": "Füge eine Titelliste ein (eine Zeile „Interpret - Titel“, oder CSV). "
                        "Soundpull sucht jeden Eintrag bei YouTube Music; du prüfst die Treffer "
                        "und lädst die bestätigten als einen Auftrag.",
        "import.placeholder": "Burial - Archangel\nAphex Twin - Windowlicker\n…",
        "import.parsed_count": "{ok} erkannt · {skipped} übersprungen",
        "import.too_many_lines": "Zu viele Zeilen (max. {max}).",
        "import.nothing_to_match": "Keine verwertbaren Zeilen gefunden.",
        "import.match_button": "Titel suchen",
        "import.busy": "Es läuft bereits eine Suche.",
        "import.error": "Suche fehlgeschlagen: {error}",
        "import.phase_queued": "In Warteschlange …",
        "import.phase_matching": "Titel werden gesucht …",
        "import.matched_heading": "Treffer ({count})",
        "import.unmatched_heading": "Ohne Treffer / nicht erkannt ({count})",
        "import.no_result": "kein Treffer",
        "import.parse_error": "Zeile nicht erkannt (Format „Interpret - Titel“)",
        "import.on_server": "in Bibliothek",
        "import.unmatched": "kein Treffer",
        "import.none_selected": "Nichts ausgewählt.",
        "import.download_button": "Auswahl laden",
    ...
    "en": {
        ...
        # Batch import (roadmap 12)
        "import.heading": "Batch import",
        "import.intro": "Paste a track list (one \"Artist - Title\" per line, or CSV). Soundpull "
                        "matches each entry against YouTube Music; you review the matches and "
                        "download the confirmed ones as a single job.",
        "import.placeholder": "Burial - Archangel\nAphex Twin - Windowlicker\n…",
        "import.parsed_count": "{ok} recognized · {skipped} skipped",
        "import.too_many_lines": "Too many lines (max {max}).",
        "import.nothing_to_match": "No usable lines found.",
        "import.match_button": "Find tracks",
        "import.busy": "A match run is already in progress.",
        "import.error": "Matching failed: {error}",
        "import.phase_queued": "Queued …",
        "import.phase_matching": "Matching tracks …",
        "import.matched_heading": "Matches ({count})",
        "import.unmatched_heading": "No match / unparsed ({count})",
        "import.no_result": "no match",
        "import.parse_error": "Line not recognized (format \"Artist - Title\")",
        "import.on_server": "in library",
        "import.unmatched": "no match",
        "import.none_selected": "Nothing selected.",
        "import.download_button": "Download selection",
